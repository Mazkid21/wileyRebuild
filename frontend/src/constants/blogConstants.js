...
export const BLOG_REVIEW_SAVE_REQUEST = 'BLOG_REVIEW_SAVE_REQUEST';
export const BLOG_REVIEW_SAVE_SUCCESS = 'BLOG_REVIEW_SAVE_SUCCESS';
export const BLOG_REVIEW_SAVE_FAIL = 'BLOG_REVIEW_SAVE_FAIL';
export const BLOG_REVIEW_SAVE_RESET = 'BLOG_REVIEW_SAVE_RESET';
